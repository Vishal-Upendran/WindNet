...
path = '../Models'+'_'+str(tv1)+'_'+str(tv2)+'/WindNet/CrossValidation/'+str(ch_filter)+'/CV_'+str(cross_valid)+'/SDOPred'+str(history)+str(delay)+'/'
...
trainpaths = sorted(glob('../Data/CrossValidation'+str(ch_filter)+'_'+str(tv1)+'_'+str(tv2)+'/CV_%d/Train/*.npy'%cross_valid))
testpaths = sorted(glob('../Data/CrossValidation'+str(ch_filter)+'_'+str(tv1)+'_'+str(tv2)+'/CV_%d/Test/*.npy'%cross_valid))
validationpaths = sorted(glob('../Data/CrossValidation'+str(ch_filter)+'_'+str(tv1)+'_'+str(tv2)+'/CV_%d/Test/*.npy'%cross_valid))
